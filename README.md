# Unofficial Snap Packaging for JBIG2 Encoder
This is the unofficial snap packaging for JBIG2 Encoder, [Snaps are universal Linux packages](https://snapcraft.io).

Refer [snap/README.md](snap/README.md) for user-oriented information.

## Remaining Tasks
Snapcrafters ([join us](https://forum.snapcraft.io/t/join-snapcrafters/1325)) are working to land snap install documentation and the [snapcraft.yaml](https://github.com/Lin-Buo-Ren/snapcrafters-template-plus/blob/master/snap/snapcraft.yaml) upstream so JBIG2 Encoder can authoritatively publish future releases.
...
- [ ] Update logos and references to `JBIG2 Encoder`, `jbig2enc` and other placeholder names in `README.md`, `snap/README.md`, and `snap/snapcraft.yaml`
